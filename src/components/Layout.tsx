...
const APP_TITLE = 'Flohmarkt-Verwaltung';
...
const navigation = [
  ...
  { name: 'Käufer', href: '/kaeufer', icon: FileText },
  { name: 'Verkäufer', href: '/verkaeufer', icon: FileText },
  { name: 'Verkäufe', href: '/verkaeufe', icon: FileText },
];

const externalNavigation = [
  { name: 'Artikel', href: '/gateway/apps/69a8093d0a4bccc713ac989f?template=list_page', icon: Package },
  { name: 'Käufer', href: '/gateway/apps/69a809430561a2e4c5582870?template=list_page', icon: FileText },
  { name: 'Verkäufer', href: '/gateway/apps/69a8092b20ac86ce582be530?template=list_page', icon: FileText },
  { name: 'Verkäufe', href: '/gateway/apps/69a80947443cc7b45049f88c?template=list_page', icon: FileText },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <nav className="px-3 pt-4 space-y-0.5">
          <a
            href="/gateway/apps/69a8093d0a4bccc713ac989f?template=list_page"
