...
export function KaeuferDialog({ open, onClose, onSubmit, defaultValues, enablePhotoScan = false, enablePhotoLocation = true }: KaeuferDialogProps) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setSaving(true);
    try {
      const clean = cleanFieldsForApi({ ...fields }, 'kaeufer');
      await onSubmit(clean as Kaeufer['fields']);
      onClose();
    } finally {
      setSaving(false);
    }
  ...
  const DIALOG_INTENT = defaultValues ? 'Käufer bearbeiten' : 'Käufer hinzufügen';
