      ...
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor="verkaeufernummer">Verkäufernummer</Label>
            <Input
              id="verkaeufernummer"
              value={fields.verkaeufernummer ?? ''}
              onChange={e => setFields(f => ({ ...f, verkaeufernummer: e.target.value }))}
            />
          </div>
          <div className="space-y-2">
