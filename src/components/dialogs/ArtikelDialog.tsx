...
export function ArtikelDialog({ open, onClose, onSubmit, defaultValues, verkaeuferList, enablePhotoScan = false, enablePhotoLocation = true }: ArtikelDialogProps) {
